...
@pytest.mark.usefixtures("client", "clean_db")
class TestResultRepository:
    """Тесты для репозитория результатов."""

    def test_get_result_by_id(self, app):
    ...
    def test_get_results_by_user(self, app):
    ...
    def test_get_results_by_workout(self, app):
    ...
    def test_delete_result(self, app):
    ...
    def test_save_result_new(self, app):
